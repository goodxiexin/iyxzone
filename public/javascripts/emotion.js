...
Iyxzone.Emotion = {
  ...
  RRE : /\<img src=\"\/images\/faces\/(惊吓|晕|流鼻涕|挖鼻子|鼓掌|骷髅|坏笑|傲慢|大哭|砸头|衰|哭|可爱|冷汗|抽烟|擦汗|亲亲|糗|吃惊|左哼哼|疑问|惊恐|睡觉|皱眉头|可怜|打呵欠|害羞|花痴|右哼哼|囧|大便|咒骂|贼笑|嘘|吐|苦恼|白眼|流汗|大笑|羞|撇嘴|偷笑|BS|困|火|闭嘴|抓狂|强|不行|装酷)\.gif\"\/\>/,
  ...
  parse: function(text){
    return text.gsub(this.RE, '<img src="/images/faces/#{1}.gif"/>');
  },

  reverse_parse: function(text){
    return text.gsub(this.RRE, '[#{1}]');
  },
