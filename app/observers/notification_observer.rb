class NotificationObserver < ActiveRecord::Observer
  ...
  def after_create notification
    ...
    Juggernaut.send_to_client "Iyxzone.startBlinkTitle('新通知');$('navnotice').innerHTML = '通知(#{user.unread_notifications_count})'; $('notifications_dropdown_list').innerHTML = ''; $('notifications_dropdown').hide(); Sound.play('/music/test.wav');", user.id
  end
