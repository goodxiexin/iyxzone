ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :user, :name_prefix => '', :path_prefix => ''  do |users|
    ...
    users.resources :mini_blogs, :collection => {:random => :get, :same_game => :get, :public => :get, :hot => :get, :sexy => :get, :other => :get, :index_list => :get, :other_list => :get, :search => :get}, :member => {:new_forward => :get, :forward => :post}
