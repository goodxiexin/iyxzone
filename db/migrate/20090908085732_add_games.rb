class AddGames < ActiveRecord::Migration
  def self.up
    ...
    wow.tag_list = "史诗, 奇幻, 角色扮演, 时间收费, 即时战斗, 3D"
    wow.save
    ...
    yonghengzhita.tag_list = "史诗, 奇幻, 角色扮演, 时间收费, 即时战斗, 3D"
    yonghengzhita.save
game3 = Game.create(
      :name => "剑侠情缘2网络版（免费版）",
      ...
      game3.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 2D"
      game3.save
game4 = Game.create(
      :name => "天堂2",
      ...
      :no_areas => true,
      :description => "韩国大型角色扮演游戏")
      game4.tag_list = "热血, 奇幻, 角色扮演, 时间收费, 道具收费, 即时战斗, 2D"
      game4.save
game5 = Game.create(
      :name => "风火之旅",
      ...
      game5.tag_list = "史诗, 奇幻, 角色扮演, 时间收费, 道具收费, 即时战斗, 3D"
      game5.save
game6 = Game.create(
      :name => "Luna",
      ...
      game6.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game6.save
game7 = Game.create(
      :name => "剑侠情缘2网络版（收费版）",
      ...
      :no_races => true,
      :description => "国产大型角色扮演游戏")
      game7.tag_list = "热血, 武侠, 角色扮演, 时间收费, 即时战斗, 2D"
      game7.save
game8 = Game.create(
      :name => "传奇归来",
      ...
      game8.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game8.save
game9 = Game.create(
      :name => "千年3",
      ...
      game9.tag_list = "热血, 武侠, 角色扮演, 时间收费, 道具收费, 即时战斗, 2D"
      game9.save
game10 = Game.create(
      :name => "剑侠情缘3",
      ...
      :agent => "金山西山居",
      :no_races => true,
      :description => "国产大型3D武侠, 角色扮演角色扮演游戏")
      game10.tag_list = "史诗, 武侠, 角色扮演, 时间收费, 即时战斗, 3D"
      game10.save
game11 = Game.create(
      :name => "超级舞者",
...
game12 = Game.create(
      ...
      :agent => "网龙",
      :no_races => true,
      :description => "国产2D武侠, 角色扮演角色扮演游戏")
      game12.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 2D"
      game12.save
game13 = Game.create(
      :name => "吞食天地online",
      ...
      game13.tag_list = "Q版, 武侠, 角色扮演, 时间收费, 道具收费, 回合战斗, 2D"
      game13.save
game14 = Game.create(
      :name => "劲舞团2",
...
game17 = Game.create(
      ...
      game17.tag_list = "史诗, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game17.save
game18 = Game.create(
      :name => "传奇世界",
      ...
      game18.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game18.save
game19 = Game.create(
      :name => "热血传奇",
      ...
      game19.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game19.save
game20 = Game.create(
      :name => "卓越之剑",
      ...
      game20.tag_list = "热血, 奇幻, 角色扮演, 时间收费, 道具收费, 即时战斗, 3D"
      game20.save
game21 = Game.create(
      :name => "天骄",
      ...
      :no_races => true,
      :description => "2D角色扮演游戏")
      game21.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 2D"
      game21.save
game22 = Game.create(
      :name => "快乐西游",
...
game23 = Game.create(
      ...
      :no_races => true,
      :description => "大型3D角色扮演游戏")
      game23.tag_list = "史诗, 武侠, 角色扮演, 道具收费, 即时战斗, 3D"
      game23.save
game24 = Game.create(
      :name => "跑跑卡丁车",
...
game26 = Game.create(
      ...
      game26.tag_list = "史诗, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game26.save
game27 = Game.create(
      :name => "三国策",
...
game28 = Game.create(
      ...
      :no_races => true,
      :description => "国产2D角色扮演游戏")
      game28.tag_list = "热血, 武侠, 角色扮演, 时间收费, 即时战斗, 2D"
      game28.save
game29 = Game.create(
      :name => "大唐豪侠",
      ...
      game29.tag_list = "热血, 武侠, 角色扮演, 时间收费, 即时战斗, 3D"
      game29.save
game30 = Game.create(
      :name => "EVE",
...
game31 = Game.create(
      ...
      :agent => "完美时空",
      :no_races => true,
      :description => "国产3D大型奇幻, 角色扮演角色扮演游戏")
      game31.tag_list = "史诗, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game31.save
game32 = Game.create(
      :name => "寻仙",
      ...
      game32.tag_list = "轻松, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game32.save
game33 = Game.create(
      :name => "梦幻诛仙",
      ...
      :no_races => true,
      :description => "2D回合制角色扮演游戏")
      game33.tag_list = "Q版, 神话, 角色扮演, 回合制战斗, 2D"
      game33.save
game34 = Game.create(
      :name => "魔域",
      ...
      game34.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game34.save
game35 = Game.create(
      :name => "问道",
      ...
      :no_races => true,
      :description => "2D回合制角色扮演游戏")
      game35.tag_list = "轻松, 神话, 角色扮演, 道具收费, 回合制战斗, 2D"
      game35.save
game36 = Game.create(
      :name => "冒险岛online",
      ...
      game36.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 横板战斗, 2D"
      game36.save
game37 = Game.create(
      :name => "巨人",
...
game38 = Game.create(
      ...
      game38.tag_list = "Q版, 武侠, 角色扮演, 道具收费, 即时战斗, 3D"
      game38.save
game39 = Game.create(
      :name => "完美世界",
      ...
      :no_races => true,
      :description => "3D神话, 角色扮演角色扮演游戏")
      game39.tag_list = "轻松, 神话, 角色扮演, 时间收费, 即时战斗, 3D"
      game39.save
game40 = Game.create(
      :name => "SD敢达",
...
game41 = Game.create(
      ...
      :agent => "网易",
      :description => "2D回合制角色扮演游戏")
      game41.tag_list = "Q版, 神话, 角色扮演, 道具收费, 回合制战斗, 2D"
      game41.save
game42 = Game.create(
      :name => "天下贰",
      ...
      game42.tag_list = "热血, 神话, 角色扮演, 时间收费, 即时战斗, 3D"
      game42.save
game43 = Game.create(
      :name => "漂流幻境",
      ...
      game43.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 回合制战斗, 2D"
      game43.save
game44 = Game.create(
      :name => "大话西游",
      ...
      game44.tag_list = "Q版, 神话, 角色扮演, 时间收费, 回合制战斗, 2D"
      game44.save
game45 = Game.create(
      :name => "口袋西游",
      ...
      game45.tag_list = "Q版, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game45.save
game46 = Game.create(
      :name => "赤壁",
      ...
      game46.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 3D"
      game46.save
game47 = Game.create(
        :name => "地下城与勇士",
    ...
    game47.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 横板战斗, 2D"
    game47.save
game48 = Game.create(
      :name => "彩虹岛online",
      ...
      game48.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 横板战斗, 2D"
      game48.save
game49 = Game.create(
      :name => "新奇迹世界",
      ...
      :no_races => true,
      :description => "3D大型角色扮演游戏")
      game49.tag_list = "史诗, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game49.save
game50 = Game.create(
      :name => "劲舞团",
...
game51 = Game.create(
      ...
      game51.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game51.save
game52 = Game.create(
      :name => "梦幻西游",
      ...
      game52.tag_list = "Q版, 神话, 角色扮演, 时间收费, 即时战斗, 2D"
      game52.save
game53 = Game.create(
      :name => "FIFA_online_2",
...
game54 = Game.create(
      ...
      :agent => "绿岸网络",
      :no_races => true,
      :description => "神话, 角色扮演类角色扮演游戏")
      game54.tag_list = "热血, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game54.save
game55 = Game.create(
      :name => "天龙八部",
      ...
      :agent => "搜狐畅游",
      :no_races => true,
      :description => "中国武侠, 角色扮演类角色扮演游戏")
      game55.tag_list = "史诗, 武侠, 角色扮演, 道具收费, 即时战斗, 3D"
      game55.save
game56 = Game.create(
      :name => "刀剑英雄",
      ...
      :agent => "搜狐畅游",
      :no_races => true,
      :description => "大型奇幻, 角色扮演网络游戏")
      game56.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game56.save
game57 = Game.create(
      :name => "征途",
      ...
      game57.tag_list = "热血, 神话, 角色扮演, 道具收费, 即时战斗, 2D"
      game57.save
game58 = Game.create(
      :name => "剑侠情缘网络版（免费版）",
...
game59 = Game.create(
      ...
      :no_races => true,
      :description => "国产2D角色扮演游戏")
      game59.tag_list = "热血, 神话, 角色扮演, 道具收费, 即时战斗, 2D"
      game59.save
game60 = Game.create(
      :name => "奇迹",
      ...
      :no_races => true,
      :description => "国产2D角色扮演游戏")
      game60.tag_list = "热血, 奇幻, 角色扮演, 时间收费, 道具收费, 即时战斗, 2D"
      game60.save
game61 = Game.create(
      :name => "功夫世界",
      ...
      :no_races => true,
      :description => "3D大型角色扮演游戏")
      game61.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 3D"
      game61.save
game62 = Game.create(
      :name => "妖怪A梦",
      ...
      game62.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 回合制战斗, 3D"
      game62.save
game63 = Game.create(
      :name => "兽血沸腾",
      ...
      :no_races => true,
      :description => "2D奇幻, 角色扮演角色扮演游戏")
      game63.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game63.save
game64 = Game.create(
      :name => "英雄无敌online",
      ...
      game64.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 回合制战斗, 2D"
      game64.save
game65 = Game.create(
      :name => "霸王2",
      ...
      game65.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game65.save
game66 = Game.create(
      :name => "洛奇",
      ...
      :no_races => true,
      :description => "Q版3D角色扮演游戏")
      game66.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game66.save
game67 = Game.create(
      :name => "盛大富翁",
...
game70 = Game.create(
      ...
      :no_races => true,
      :description => "2D奇幻, 角色扮演角色扮演游戏")
      game70.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game70.save
game71 = Game.create(
      :name => "预言online",
      ...
      :no_races => true,
      :description => "2D奇幻, 角色扮演角色扮演游戏")
      game71.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game71.save
game72 = Game.create(
      :name => "新武林外传",
      ...
      game72.tag_list = "Q版, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game72.save
game73 = Game.create(
      :name => "新飞飞",
      ...
      :no_races => true,
      :description => "Q版3D角色扮演游戏")
      game73.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game73.save
game74 = Game.create(
      :name => "宝贝坦克",
...
game75 = Game.create(
      ...
      :agent => "多益网络",
      :description => "2D回合制角色扮演游戏")
      game75.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 回合制战斗, 2D"
      game75.save
game76 = Game.create(
      :name => "天神世界",
      ...
      :no_races => true,
      :description => "3D奇幻, 角色扮演角色扮演游戏")
      game76.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game76.save
game77 = Game.create(
      :name => "剑侠世界",
      ...
      game77.tag_list = "热血, 武侠, 角色扮演, 道具收费, 即时战斗, 2D"
      game77.save
game78 = Game.create(
      :name => "机甲世纪",
...
game80 = Game.create(
      ...
      :no_races => true,
      :description => "3D奇幻, 角色扮演角色扮演游戏")
      game80.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 3D"
      game80.save
game81 = Game.create(
      :name => "仙剑online",
      ...
      :no_races => true,
      :description => "3D神话, 角色扮演角色扮演游戏")
      game81.tag_list = "热血, 神话, 角色扮演, 道具收费, 即时战斗, 3D"
      game81.save
game82 = Game.create(
      :name => "真三国无双",
...
game83 = Game.create(
      ...
      game83.tag_list = "Q版, 神话, 角色扮演, 道具收费, 回合制战斗, 3D"
      game83.save
game84 = Game.create(
      :name => "航海世纪",
...
game85 = Game.create(
      ...
      :agent => "新浪乐谷",
      :description => "2D奇幻, 角色扮演角色扮演游戏")
      game85.tag_list = "热血, 奇幻, 角色扮演, 时间收费, 即时战斗, 2D"
      game85.save
game86 = Game.create(
      :name => "石器世界",
...
game87 = Game.create(
      ...
      game87.tag_list = "Q版, 神话, 角色扮演, 道具收费, 回合制战斗, 2D"
      game87.save
game88 = Game.create(
      :name => "劲舞世界",
...
game89 = Game.create(
      ...
      :no_races => true,
      :description => "2D回合制角色扮演游戏")
      game89.tag_list = "Q版, 神话, 角色扮演, 道具收费, 回合制战斗, 3D"
      game89.save
game90 = Game.create(
      :name => "华夏2",
      ...
      :agent => "腾讯",
      :no_races => true,
      :description => "2D奇幻, 角色扮演角色扮演")
      game90.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game90.save
game91 = Game.create(
      :name => "王者世界",
      ...
      game91.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 回合制战斗, 3D"
      game91.save
game92 = Game.create(
      :name => "疯狂赛车2",
...
game94 = Game.create(
      ...
      :no_races => true,
      :description => "回合制角色扮演游戏")
      game94.tag_list = "热血, 奇幻, 角色扮演, 时间收费, 回合制战斗, 3D"
      game94.save
game95 = Game.create(
      :name => "勇气online",
      ...
      game95.tag_list = "Q版, 武侠, 角色扮演, 道具收费, 即时战斗, 2D"
      game95.save
game96 = Game.create(
      :name => "冲锋岛",
      ...
      game96.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 横板战斗, 2D"
      game96.save
game97 = Game.create(
      :name => "魔力宝贝2",
      ...
      game97.tag_list = "Q版, 奇幻, 角色扮演, 道具收费, 半即时制战斗, 3D"
      game97.save
game98 = Game.create(
      :name => "刀剑英雄2",
      ...
      :no_races => true,
      :description => "2D奇幻, 角色扮演角色扮演游戏")
      game98.tag_list = "热血, 奇幻, 角色扮演, 道具收费, 即时战斗, 2D"
      game98.save
game99 = Game.create(
      :name => "英雄连online",
